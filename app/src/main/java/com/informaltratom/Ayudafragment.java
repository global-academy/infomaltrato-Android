...
public class Ayudafragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ayudafragment, container, false);
        infoBoton = (Button) view.findViewById(R.id.informacionApp);
        infoBoton.setOnClickListener(new View.OnClickListener(){
                                              ...
                                              public void onClick(View v) {
                                                  ...
                                                  Intent intent = new Intent(v.getContext(),InformacionAplicacionActivity.class);
